                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab1">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="table-responsive" style="overflow-x: scroll;">
                                            <button class="btn btn-primary" id="export" style="float: left;margin-bottom: 15px;">خروجی اکسل</button>
                                            <table id="table2excel" class="table table-bordered table-striped table-condensed">
                                                <thead>
                                                <tr>
                                                ...
                                                <?php
                                                $index = -1;
                                                foreach ($orderPerson as $op) { $index +=1;
                                                    $avgAll = array(); ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $op['PersonFirstName']; ?></td>
                                                        <td class="text-center"><?php echo $op['PersonLastName']; ?></td>
                                                        <td class="text-center"><?php echo $op['PersonNationalCode']; ?></td>
                                                        <td class="text-center"><?php echo $op['PersonPhone']; ?></td>
                                                        <?php foreach ($orderModelAbility as $item) {
                                                            $avg = array(); ?>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            if (is_nan(array_sum($avgAll) / sizeof($avgAll))) {
                                                                ...
                                                                echo round(array_sum($avgAll) / sizeof($avgAll));
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <table class="table table-bordered table-condensed table-striped">
                                                ...
                                                <tr  style="background: #127d88;color:#fff;">
                                                    <th style="vertical-align: middle" class="text-center" rowspan="2"><?php echo $item['AbilityTitle']; ?></th>
                                                    <th colspan="2">
                                                        <table>
                                                            <tr  style="background: #127d88;color:#fff;">
