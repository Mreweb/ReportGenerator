...
<head>
    ...
    <script type="text/javascript">
        var base_url = "<?php echo base_url('Customer/Panel/'); ?>";
    </script>
</head>
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li>
                            <a href="<?php echo base_url('Customer/Panel/Profile'); ?>">
                                <i class="material-icons">person</i>
                                <span>پروفایل</span>
                          </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('Customer/Home/doLogOut'); ?>">
        ...
        <div class="menu">
            ...
            <ul class="list">
                <li <?php if (strstr($uri , "Home") !== false) echo "class='active'"; ?>>
                    <a href="<?php echo base_url('Customer/Panel/Home'); ?>">
                ...
                <?php if(isFoundationRole()){ ?>
                    <li <?php echo $CI->uri->segment(2) == 'Foundation' ? 'class="active"' : '' ?>>
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            <i class="material-icons">bookmark</i>
                            <span>مدیر کانون</span>
                        </a>
                        <ul class="ml-menu" style="display: none;">
                            <li <?php if (strstr($uri, '/Foundation/manager') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/Foundation/manager/'.getLoggedFoundationId()); ?>" class="waves-effect waves-block">فهرست</a>
                            </li>
                        </ul>
                    </li>
                <?php } ?>
                ...
                <?php if(isFoundationManagerRole()){ ?>
                    <li <?php echo $CI->uri->segment(2) == 'FoundationPlanManager' ? 'class="active"' : '' ?> >
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            <i class="material-icons">bookmark</i>
                            <span>مدیر برنامه</span>
                        </a>
                        <ul class="ml-menu" style="display: none;">
                            <li <?php if (strstr($uri, '/FoundationPlanManager/index') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/FoundationPlanManager/index'); ?>" class="waves-effect waves-block">فهرست</a>
                            </li>
                            <li <?php if (strstr($uri, '/FoundationPlanManager/add') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/FoundationPlanManager/add'); ?>"
                                   class="waves-effect waves-block">افزودن</a>
                            </li>
                        </ul>
                    </li>
                ...
                <?php if(isFoundationManagerRole()){ ?>
                    <li <?php echo $CI->uri->segment(2) == 'FoundationValuer' ? 'class="active"' : '' ?> >
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            <i class="material-icons">bookmark</i>
                            <span>ارزیاب</span>
                        </a>
                        <ul class="ml-menu" style="display: none;">
                            <li <?php if (strstr($uri, '/FoundationValuer/index') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/FoundationValuer/index'); ?>" class="waves-effect waves-block">فهرست</a>
                            </li>
                            <li <?php if (strstr($uri, '/FoundationValuer/add') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/FoundationValuer/add'); ?>"
                                   class="waves-effect waves-block">افزودن</a>
                            </li>
                        </ul>
                    </li>
                ...
                <?php if(isFoundationRole()){ ?>
                    <li <?php echo $CI->uri->segment(2) == 'Customer' ? 'class="active"' : '' ?> >
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            <i class="material-icons">bookmark</i>
                            <span>مشتریان</span>
                        </a>
                        <ul class="ml-menu" style="display: none;">
                            <li <?php if (strstr($uri, '/Customer/index') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/Customer/index'); ?>" class="waves-effect waves-block">فهرست</a>
                            </li>
                            <li <?php if (strstr($uri, '/Customer/add') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/Customer/add'); ?>"
                                   class="waves-effect waves-block">افزودن</a>
                            </li>
                        </ul>
                    </li>
                ...
                <?php if(isFoundationRole() || isFoundationManagerRole()){ ?>
                    ...
                    <ul class="ml-menu" style="display: none;">
                        ...
                        <?php } ?>
                        <?php if(isFoundationManagerRole()){ ?>
                            <li <?php if (strstr($uri, '/Orders/managerOrders') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/Orders/managerOrders'); ?>" class="waves-effect waves-block">سفارش های من</a>
                            </li>
                        <?php } ?>
                    </ul>
                </li>
                ...
                <?php if(isAdminRole()){ ?>
                    ...
                    <?php echo $CI->uri->segment(2) == 'States' ? 'class="active"' : '' ?>>
                    <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                        <i class="material-icons">bookmark</i>
                    ...
                    <ul class="ml-menu" style="display: none;">
                        <li <?php if (strstr($uri, '/States/index') !== false) echo "class='active'"; ?>>
                            <a href="<?php echo base_url('Panel/States/index'); ?>" class="waves-effect waves-block">فهرست استان ها</a>
                        </li>
                    </ul>
                </li>
                <?php } ?>
                ...
                <?php if(isFoundationValuerRole()){ ?>
                    <li<?php echo $CI->uri->segment(4) == 'ValuerList' ? 'class="active"' : '' ?>>
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            <i class="material-icons">bookmark</i>
                            <span>ارزیابی ها</span>
                        </a>
                        <ul class="ml-menu" style="display: none;">
                            <li <?php if (strstr($uri, 'ValuerList') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/ValuerList'); ?>" class="waves-effect waves-block">فهرست </a>
                            </li>
                        </ul>
                    </li>
                <?php } ?>
                ...
                <?php if(isFoundationPlanManagerRole()){ ?>
                    <li<?php echo $CI->uri->segment(4) == 'WashUpOrders' ? 'class="active"' : '' ?>>
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            <i class="material-icons">bookmark</i>
                            <span>واش آپ</span>
                        </a>
                        <ul class="ml-menu" style="display: none;">
                            <li <?php if (strstr($uri, 'WashUpOrders') !== false) echo "class='active'"; ?>>
                                <a href="<?php echo base_url('Panel/WashUpOrders'); ?>" class="waves-effect waves-block">فهرست </a>
                            </li>
                        </ul>
                    </li>
                <?php } ?>
