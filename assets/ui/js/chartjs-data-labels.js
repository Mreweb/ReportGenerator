!function (t, e) {
    ...
    var d = function (t, e) {
        var r = (t.startAngle + t.endAngle) / 2, a = Math.cos(r), o = Math.sin(r), n = t.innerRadius,
            i = t.outerRadius;
    ...
    t.merge(_.prototype, {
        _modelize: function (r, a, n, i) {
            ...
            c && (r = e.dataset.data[u], o = t.valueOrDefault(t.callback(d.formatter, [r, e]), r), (n = t.isNullOrUndef(o) ? [] : a(o)).length && (s = function (t) {
                var e = t.borderWidth || 0, r = t.padding, a = t.size.height, o = t.size.width, n = -o / 2,
                    i = -a / 2;
                return {
                    frame: {
                        x: n - r.left - e,
    ...
    function I(t, e) {
        ...
        if (n.enter || n.leave) {
            ...
            r = o._hovered, o._hovered = a, function (t, e, r, a) {
                var o, n;
